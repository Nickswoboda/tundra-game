...
OptionsScene::OptionsScene()
{
	...
	resolution_dropdown_ = ui_layer_->AddWidget<Aegis::Dropdown>(new Aegis::Dropdown("Resolution", { 580, 210, 200, 32 }));
	...
	vsync_checkbox_ = ui_layer_->AddWidget<Aegis::Checkbox>(new Aegis::Checkbox("Vsync", { 780, 400, 200, 32 }, [](bool vsync) {Aegis::Application::GetWindow().SetVsync(vsync);}));
	...
	back_button_ = ui_layer_->AddWidget<Aegis::Button>(new Aegis::Button({ 580, 600, 200, 32 }, "Back", [&]() {manager_->PopScene(); }));
