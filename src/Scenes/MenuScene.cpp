...
MenuScene::MenuScene() 
{
	...
	new_game_button_ = ui_layer_->AddWidget<Aegis::Button>(new Aegis::Button({ 580, 170, 200, 50 }, "", [&]() {manager_->PushScene(std::unique_ptr<Scene>(new GameplayScene(0))); }));
	level_select_button_ = ui_layer_->AddWidget<Aegis::Button>(new Aegis::Button({ 580, 220, 200, 50 }, "", [&]() {manager_->PushScene(std::unique_ptr<Scene>(new LevelSelectScene())); }));
	options_button_ = ui_layer_->AddWidget<Aegis::Button>(new Aegis::Button({ 580, 230, 200, 50 }, "", [&]() {manager_->PushScene(std::unique_ptr<Scene>(new OptionsScene())); }));
	exit_button_ = ui_layer_->AddWidget<Aegis::Button>(new Aegis::Button({ 580, 270, 200, 50 }, "", [&]() { Aegis::Application::Quit(); }));
